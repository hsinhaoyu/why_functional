...
We'll test the second version of our numerical integration function, too:
#+begin_src python :noweb yes :tangle ../src/test_integrate.py
  def test_integrate2():
      print("\n## test_integrate2()")
      a, b = 0.0, pi 
...
Remember that in =diff.org=, we used the =improve= function to accelerate the convergence of a sequence? We can use it here too:
